                ...
                <div class="form-body">
                  ...
                  <div class="field-row">
                    <div class="field">
                      ...
                      <span class="field-err" v-if="submitted && !form.contactStatus"
                        >請選擇聯繫狀態</span
                      >
                    </div>
                    ...
                    <div class="field">
                      ...
                      <span class="field-err" v-if="submitted && !form.contactChannel"
                        >請選擇聯繫管道</span
                      >
                    </div>
                  </div>
                  ...
                  <button class="submit-btn" @click="submitLog" :disabled="submitLoading">
