...
public class CustomerServiceImpl implements CustomerService {
    ...
    public void seedTestData() {
        ...
        String insertProfile = """
                INSERT INTO customer_profile (customer_id, cif, id_number, name, birthday, gender, email, phone, address, status, avatar_url) VALUES
                ('X7K9P2M4', '2605-A3R5W8J1', 'A123456789', N'王大明', '1985-05-15', 'M', 'ming.wang@email.com', '0912000001', N'台北市信義區信義路五段1號', 'ACTIVE', '/daming_profile.jpg'),
                ('V4L6T1Y8', '2605-N9Q2E7C4', 'B223456789', N'林小華', '1990-08-22', 'F', 'hua.lin@email.com', '0912000002', N'台中市西屯區台灣大道三段99號', 'ACTIVE', '/avatars/default.png'),
                ('D3H8F5G2', '2605-M1V6P4K9', 'C123456789', N'陳建國', '1978-11-03', 'M', 'chien.chen@email.com', '0912000003', N'高雄市三民區建國一路1號', 'ACTIVE', '/avatars/default.png'),
                ('B9W1C7R5', '2605-H5T2J8X3', 'D223456789', N'張雅婷', '1995-02-14', 'F', 'ya.chang@email.com', '0912000004', N'台南市東區大學路1號', 'ACTIVE', '/avatars/default.png'),
                ('P6M4N2Q8', '2605-L7F3Y1W6', 'E123456789', 'chih.lee@email.com', '0912000005', N'新北市板橋區中山路一段161號', 'ACTIVE', '/avatars/default.png'),
                ('K1T9V5L3', '2605-C4G8R2M5', 'F223456789', N'吳美玲', '1988-12-10', 'F', 'mei.wu@email.com', '0912000006', N'桃園市中壢區中大路300號', 'ACTIVE', '/avatars/default.png'),
                ('E8C2X7J4', '2605-T6N1P9V8', 'G123456789', N'黃文輝', '1975-04-05', 'M', 'wen.huang@email.com', '0912000007', N'新竹市東區光復路二段101號', 'INACTIVE', '/avatars/default.png'),
                ('Y5R4W1H6', '2605-F2K7M3L9', 'H223456789', N'蔡佳蓉', '1992-09-18', 'F', 'chia.tsai@email.com', '0912000008', N'苗栗縣苗栗市縣府路100號', 'ACTIVE', '/avatars/default.png'),
                ('G7N3M8P2', '2605-X1W5C4T6', 'I123456789', N'劉冠宇', '1980-01-25', 'M', 'kuan.liu@email.com', '0912000009', N'彰化縣彰化市中山路二段416號', 'ACTIVE', '/avatars/default.png'),
                ('J2F6K9V1', '2605-R8Y4H7N2', 'J223456789', N'許家瑩', '1998-06-08', 'F', 'chia.hsu@email.com', '0912000010', N'南投縣南投市中興路660號', 'ACTIVE', '/avatars/default.png'),
                ('Q4W8C1T7', '2605-V3L9M2P5', 'K123456789', N'鄭宗翰', '1986-10-12', 'M', 'tsung.cheng@email.com', '0912000011', N'雲林縣斗六市雲林路二段515號', 'ACTIVE', '/avatars/default.png'),
                ('M9P2R5N4', '2605-J7X1W6C8', 'L223456789', N'洪玉婷', '1991-03-20', 'F', 'yu.hung@email.com', '0912000012', N'嘉義市東區中山路199號', 'ACTIVE', '/avatars/default.png'),
                ('H3T7J1V9', '2605-K4F8N5R2', 'M123456789', N'邱信宏', '1979-08-05', 'M', 'hsin.chiu@email.com', '0912000013', N'屏東縣屏東市自由路527號', 'ACTIVE', '/avatars/default.png'),
                ('L5V1M6P3', '2605-W9T2C7H4', 'N223456789', N'曾婉茹', '1994-11-28', 'F', 'wan.tseng@email.com', '0912000014', N'宜蘭縣宜蘭市縣政北路1號', 'ACTIVE', '/avatars/default.png'),
                ('R8K4N9M2', '2605-P1V5J3X6', 'O123456789', N'廖偉翔', '1983-05-10', 'M', 'wei.liao@email.com', '0912000015', N'花蓮縣花蓮市府前路17號', 'ACTIVE', '/avatars/default.png'),
                ('T1C7W4R8', '2605-N6M2L9F5', 'P223456789', 'yi.lai@email.com', '0912000016', N'台東縣台東市中山路276號', 'ACTIVE', '/avatars/default.png'),
                ('N6M9P2V5', '2605-C8H1T4K7', 'Q123456789', N'徐俊傑', '1976-02-18', 'M', 'chun.hsu@email.com', '0912000017', N'澎湖縣馬公市治平路32號', 'ACTIVE', '/avatars/default.png'),
                ('W2R5T8C1', '2605-M7N3P6V9', 'R223456789', N'卓佩樺', '1996-07-07', 'F', 'pei.cho@email.com', '0912000018', N'基隆市中正區義一路1號', 'ACTIVE', '/avatars/default.png'),
                ('C4H1K7N9', '2605-V5L2W8R3', 'S123456789', N'江宇軒', '1989-09-30', 'M', 'yu.chiang@email.com', '0912000019', N'台北市中正區重慶南路一段122號', 'ACTIVE', '/avatars/default.png'),
                ('V7P3M1R6', '2605-T9C4F2J8', 'T223456789', N'郭欣儀', '1993-04-25', 'F', 'hsin.kuo@email.com', '0912000020', N'新北市三重區重新路一段1號', 'ACTIVE', '/avatars/default.png')
                """;
        ...
        String insertApplication = """
                ...
                ('APP260428004', 'B9W1C7R5', '2605-H5T2J8X3', 'D223456789', 'ya.chang@email.com', '0912000004', N'台南市東區大學路1號', 'yachang95', 'APPROVED'),
                ('APP260428005', 'P6M4N2Q8', '2605-L7F3Y1W6', 'E123456789', 'chih.lee@email.com', '0912000005', N'新北市板橋區中山路一段161號', 'chihlee82', 'APPROVED'),
                ('APP260428006', 'K1T9V5L3', '2605-C4G8R2M5', 'F223456789', 'mei.wu@email.com', '0912000006', N'桃園市中壢區中大路300號', 'meiwu88', 'APPROVED'),
                ('APP260428007', 'E8C2X7J4', '2605-T6N1P9V8', 'G123456789', 'wen.huang@email.com', '0912000007', N'新竹市東區光復路二段101號', 'wenhuang75', 'APPROVED'),
                ('APP260428008', 'Y5R4W1H6', '2605-F2K7M3L9', 'H223456789', 'chia.tsai@email.com', '0912000008', N'苗栗縣苗栗市縣府路100號', 'chiatsai92', 'APPROVED'),
                ('APP260428009', 'G7N3M8P2', '2605-X1W5C4T6', 'I123456789', 'kuan.liu@email.com', '0912000009', N'彰化縣彰化市中山路二段416號', 'kuanliu80', 'APPROVED'),
                ('APP260428010', 'J2F6K9V1', '2605-R8Y4H7N2', 'J223456789', 'chia.hsu@email.com', '0912000010', N'南投縣南投市中興路660號', 'chiahsu98', 'APPROVED'),
                ('APP260428011', 'Q4W8C1T7', '2605-V3L9M2P5', 'K123456789', 'tsung.cheng@email.com', '0912000011', N'雲林縣斗六市雲林路二段515號', 'tsungcheng86', 'APPROVED'),
                ('APP260428012', 'M9P2R5N4', '2605-J7X1W6C8', 'L223456789', 'yu.hung@email.com', '0912000012', N'嘉義市東區中山路199號', 'yuhung91', 'APPROVED'),
                ('APP260428013', 'H3T7J1V9', '2605-K4F8N5R2', 'M123456789', 'hsin.chiu@email.com', '0912000013', N'屏東縣屏東市自由路527號', 'hsinchiu79', 'APPROVED'),
                ('APP260428014', 'L5V1M6P3', '2605-W9T2C7H4', 'N223456789', 'wan.tseng@email.com', '0912000014', N'宜蘭縣宜蘭市縣政北路1號', 'wantseng94', 'APPROVED'),
                ('APP260428015', 'R8K4N9M2', '2605-P1V5J3X6', 'O123456789', 'wei.liao@email.com', '0912000015', N'花蓮縣花蓮市府前路17號', 'weiliao83', 'APPROVED'),
                ('APP260428016', 'T1C7W4R8', '2605-N6M2L9F5', 'P223456789', 'yi.lai@email.com', '0912000016', N'台東縣台東市中山路276號', 'yilai87', 'APPROVED'),
                ('APP260428017', 'N6M9P2V5', '2605-C8H1T4K7', 'Q123456789', 'chun.hsu@email.com', '0912000017', N'澎湖縣馬公市治平路32號', 'chunhsu76', 'APPROVED'),
                ('APP260428018', 'W2R5T8C1', '2605-M7N3P6V9', 'R223456789', 'pei.cho@email.com', '0912000018', N'基隆市中正區義一路1號', 'peicho96', 'APPROVED'),
                ('APP260428019', 'C4H1K7N9', '2605-V5L2W8R3', 'S123456789', 'yu.chiang@email.com', '0912000019', N'台北市中正區重慶南路一段122號', 'yuchiang89', 'APPROVED'),
                ('APP260428020', 'V7P3M1R6', '2605-T9C4F2J8', 'T223456789', 'hsin.kuo@email.com', '0912000020', N'新北市三重區重新路一段1號', 'hsinkuo93', 'APPROVED')
                """;
